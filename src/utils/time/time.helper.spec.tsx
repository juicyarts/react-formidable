...
describe('TimeHelper', () => {
  describe('formatDateTimeString', () => {
    it('should return date in format YYYY-MM-DD', () => {
      expect(
        formatDateTimeString('2021-03-12T12:38:04.0371616+00:00', DateTimeFormat.YYYMMDD),
      ).toBe('2021-03-12');
    });
    ...
    it('should return empty string when given undefined args', () => {
      expect(formatDateTimeString(undefined, DateTimeFormat.YYYMMDD)).toBe('');
    });

    it('should parse dates with 1-3 digit years correctly', () => {
      expect(
        formatDateTimeString('0001-12-10T12:38:04.0371616+00:00', DateTimeFormat.YYYMMDD),
      ).toBe('0001-12-10');
    });
  });
});
